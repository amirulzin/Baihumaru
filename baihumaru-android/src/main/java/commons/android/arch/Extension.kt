...
fun <T : Any> AutoRefreshLiveData<T>.observeTerminalStateAsToast(owner: LifecycleOwner, context: Context?) {
...
fun <T : Any> AutoRefreshLiveData<T>.showToastForError(context: Context?, resourceState: ResourceState) {
